...
final <- p + 
  annotate("text",  x = 8, y = 25, family = "Source Sans Pro", label = "Billboard 100's\nTop 10\n#1 Songs\nby Decade", hjust = 1, vjust = 0, colour = "black", size = 14, lineheight = 1) +
