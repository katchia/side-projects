...
There are a lot of tracks. Let's just focus on the top one from each type () to keep this succinct!
...
overall_means_plot <- overall_means + labs(x = "Mean Times",
                                    y = "Track",
                                    fill = "Track"
                                    )
...
overall_dot <- dot + labs(x = "Mean Times",
                          y = "Track",
                          fill = "Type")
